...
type StorageMiner interface {
	...
	ReturnProveReplicaUpdate(ctx context.Context, callID storiface.CallID, proof storage.ReplicaUpdateProof, err *storiface.CallError) error //perm:admin retry:true
